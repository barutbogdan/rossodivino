...
class AdminServiceProvider extends ServiceProvider
{
    ...
    {
        \Validator::extend('slim_image', function ($attribute, $value, $parameters, $validator) {

            $slim = Slim::parseInput($value);

            $width = Arr::get($slim, 'output.width', 0);
            $height = Arr::get($slim, 'output.height', 0);
