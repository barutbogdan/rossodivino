...
class TeamCategoryController extends Controller
{
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header(trans('admin::lang.team_categories'));
    ...
    {
        return Admin::grid(TeamCategory::class, function (Grid $grid) {
            ...
            $grid->status(trans('admin::lang.status'))->value(function ($value) {
                return $value == TeamCategory::ENUM_ACTIVE ? trans('admin::lang.active') : trans('admin::lang.inactive');
            });
    ...
    {
        return Admin::form(TeamCategory::class, function (Form $form) {
            ...
            $form->switch('status', trans('admin::lang.status'))->states([
                'on'  => ['value' => TeamCategory::ENUM_ACTIVE],
                'off' => ['value' => TeamCategory::ENUM_INACTIVE]
            ]);
        });
    }
}
